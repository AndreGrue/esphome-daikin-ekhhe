...
DEPENDENCIES = ["uart", "button", "switch", "time"]

daikin_ekhhe_ns = cg.esphome_ns.namespace("daikin_ekkhe")
DaikinEkhhe = daikin_ekhhe_ns.class_(
    "DaikinEkhheComponent", cg.Component, uart.UARTDevice
)
MULTI_CONF = True
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_MODE, default="production"): cv.one_of(
            "production", "debug", lower=True
        ),
    }
