...
static const std::string E_EVA_INLET_T_PROBE =
    "evaporator_inlet_gas_temp_probe";
static const std::string F_EVA_OUTLET_T_PROBE =
    "evaporator_outlet_gas_temp_probe";
static const std::string G_COMP_GAS_T_PROBE =
...
static const std::string P21_LOW_WAT_T_HP_STOP =
    "low_water_hp_pv_mode_threshold";
static const std::string P22_UP_WAT_T_EH_STOP =
...
static const std::string P35_EEV_SH_SETPOINT =
    "eev_control_superheating_setpoint";
static const std::string P36_EEV_DSH_SETPOINT =
...
static const std::string P49_EVA_INLET_THRES =
    "evaporator_inlet_temp_threshold_blower";
static const std::string P50_ANTIFREEZE_SET =
